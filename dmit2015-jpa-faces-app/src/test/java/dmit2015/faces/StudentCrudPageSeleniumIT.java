...
//        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
    ...
    @ParameterizedTest
    @CsvSource(value = {
            "firstName, Aamir, lastName, Mughal, courseSection, DMIT2015-OE01,",
            "firstName, Austin, lastName, Tomas, courseSection, DMIT2015-OE01,",
            "firstName, Tyrrell, lastName, Dakin, courseSection, DMIT2015-OE01,",
    })
    void shouldCreate(
    ...
    @ParameterizedTest
    @CsvSource({
            "0, Aamir, Mughal, DMIT2015-OE01",
            "1, Austin, Tomas, DMIT2015-OE01",
            "2, Tyrrell, Dakin, DMIT2015-OE01",
    })
    void shouldList(
            int idIndex,
