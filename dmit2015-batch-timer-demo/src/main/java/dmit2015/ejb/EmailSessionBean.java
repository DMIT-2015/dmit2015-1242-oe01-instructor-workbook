...
/**
 * To send email with the Wildfly mail subsystem you must first configure the default mail session with your
 * own email account as follows:
 *         Step 1: Start the JBoss WildFly server
 *         Step 2: Open a Terminal window and type in the following commands to configure the mail subsystem with
 *         your own email account info.
 * {@snippet lang="shell" :
