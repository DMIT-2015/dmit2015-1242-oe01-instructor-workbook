...
import dmit2015.dto.StudentMapper;
...
public class StudentDtoResource {
    ...
    // Restrict access to the Marketing, Sales, and Administration role
    @RolesAllowed({"Marketing","Sales","Administration"})
    @Path("{id}")
    @GET    // This method only accepts HTTP GET requests.
    ...
    // Restrict access to the Marketing Role
    ...
    // Restrict access to the Marketing and Sales role
    ...
    // Restrict access to the Administration role
